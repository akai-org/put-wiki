    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        className={cn(
          ...
          side === 'top' &&
            'inset-x-0 top-0 h-auto origin-top border-b data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
          side === 'bottom' &&
