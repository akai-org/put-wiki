...
public class OAuth1Tests
{
    ...
    {
        OAuth1.UrlEncode(input).Should().Be(expected);
    }
    ...
    public void Signature_ShouldMatchRfc5849Example()
    {
        ...
        var baseString = OAuth1.CreateSignatureBaseString("GET", url, parameters);
        baseString
            .Should()
            .Be(
        ...
        var signature = OAuth1.ComputeHmacSha1Signature(baseString, "kd94hf93k423kf44", "pfkkdhi9sl3r4s00");
