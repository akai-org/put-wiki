...
* Follow the instructions in `client/README.md` and `server/README.md` to run the development environments.  
  *(Alternatively, run the entire stack using Docker Compose.)* **NOT WORKING YET**
...
*Product documentation (vision, scope, requirements) can be found in the [`docs/product/`](docs/product/) folder.*
